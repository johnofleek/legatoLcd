...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1ea11j2iah6px.iot.eu-central-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_ROOT_CA_FILENAME       "Root.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "77668df067-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "77668df067-private.pem.key" ///< Device private key filename
// =================================================
