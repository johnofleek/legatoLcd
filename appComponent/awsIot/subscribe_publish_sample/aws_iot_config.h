...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "abcwpkivo94xw.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "awsWasp1" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "awsWasp1" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "VeriSign-Class 3-Public-Primary-Certification-Authority-G5.pem.txt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "758625dd35-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "758625dd35-private.pem.key" ///< Device private key filename
// =================================================
