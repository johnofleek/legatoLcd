...
// Startup code for the executable 'lcd'.
...
LE_SHARED le_log_Level_t* lcd_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    lcd_exe_LogSession = log_RegComponent("lcd_exe", &lcd_exe_LogLevelFilterPtr);
